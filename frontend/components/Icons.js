...
// Pass className for size; color via Tailwind text-* or style prop.

export function TraceVaultMark({ className = 'w-6 h-6', style }) {
  return (
    <svg className={className} style={style} viewBox="0 0 24 24" fill="none">
      {/* Hex outer */}
      <path
        d="M12 2L21 7v10L12 22L3 17V7L12 2z"
        stroke="currentColor" strokeWidth="1.25" strokeLinejoin="round"
      />
      {/* Inner trace path */}
      <circle cx="8.5"  cy="12" r="1.5" fill="currentColor" />
      <circle cx="15.5" cy="12" r="1.5" fill="currentColor" />
      <line x1="10" y1="12" x2="14" y2="12" stroke="currentColor" strokeWidth="1.25" strokeLinecap="round" />
    </svg>
  )
}

export function SearchIcon({ className = 'w-4 h-4', style }) {
  return (
...
export function DatabaseIcon({ className = 'w-4 h-4', style }) {
  return (
    <svg className={className} style={style} viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
...
export function ActivityIcon({ className = 'w-4 h-4', style }) {
  return (
    <svg className={className} style={style} viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
...
export function AlertIcon({ className = 'w-4 h-4', style }) {
  return (
    <svg className={className} style={style} viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
...
export function CheckIcon({ className = 'w-4 h-4', style }) {
  return (
    <svg className={className} style={style} viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
...
export function WrenchIcon({ className = 'w-4 h-4', style }) {
  return (
    <svg className={className} style={style} viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
...
export function LayersIcon({ className = 'w-4 h-4', style }) {
  return (
    <svg className={className} style={style} viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
...
export function TagIcon({ className = 'w-4 h-4', style }) {
  return (
    <svg className={className} style={style} viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
...
export function TerminalIcon({ className = 'w-4 h-4', style }) {
  return (
    <svg className={className} style={style} viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
...
export function SparkleIcon({ className = 'w-4 h-4', style }) {
  return (
    <svg className={className} style={style} viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
...
export function UploadIcon({ className = 'w-4 h-4', style }) {
  return (
    <svg className={className} style={style} viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
...
export function ZapIcon({ className = 'w-4 h-4', style }) {
  return (
    <svg className={className} style={style} viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
